...
package registrationsmtreplicator
...
// RegistrationSMTReplicatorInit is a paid mutator transaction binding the contract method 0x0e99c4f8.
//
// Solidity: function __RegistrationSMTReplicator_init(address signer_, string chainName_) returns()
func (_RegistrationSMTReplicator *RegistrationSMTReplicatorTransactor) RegistrationSMTReplicatorInit(opts *bind.TransactOpts, signer_ common.Address, chainName_ string) (*types.Transaction, error) {
	return _RegistrationSMTReplicator.contract.Transact(opts, "__RegistrationSMTReplicator_init", signer_, chainName_)
}

// RegistrationSMTReplicatorInit is a paid mutator transaction binding the contract method 0x0e99c4f8.
//
// Solidity: function __RegistrationSMTReplicator_init(address signer_, string chainName_) returns()
func (_RegistrationSMTReplicator *RegistrationSMTReplicatorSession) RegistrationSMTReplicatorInit(signer_ common.Address, chainName_ string) (*types.Transaction, error) {
	return _RegistrationSMTReplicator.Contract.RegistrationSMTReplicatorInit(&_RegistrationSMTReplicator.TransactOpts, signer_, chainName_)
}

// RegistrationSMTReplicatorInit is a paid mutator transaction binding the contract method 0x0e99c4f8.
//
// Solidity: function __RegistrationSMTReplicator_init(address signer_, string chainName_) returns()
func (_RegistrationSMTReplicator *RegistrationSMTReplicatorTransactorSession) RegistrationSMTReplicatorInit(signer_ common.Address, chainName_ string) (*types.Transaction, error) {
	return _RegistrationSMTReplicator.Contract.RegistrationSMTReplicatorInit(&_RegistrationSMTReplicator.TransactOpts, signer_, chainName_)
}
